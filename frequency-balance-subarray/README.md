...
Problem Link: https://leetcode.com/problems/frequency-balance-subarray/  
Submitted At: 2026-06-14
...
<p>Define a <strong>frequency balance <span data-keyword="subarray-nonempty" class=" cursor-pointer relative text-dark-blue-s text-sm"></span></strong> as follows:</p>

<ul>
	<li>If the subarray contains only one distinct value, it is frequency balanced.</li>
	<li>Otherwise, there must exist a positive integer <code>f</code> such that every distinct value in the subarray occurs either <code>f</code> or <code>2 * f</code> times, and both <span data-keyword="frequency-array" class=" cursor-pointer relative text-dark-blue-s text-sm"></span> occur among the distinct values.</li>
</ul>
