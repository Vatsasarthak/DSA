...
Problem Link: https://leetcode.com/problems/maximize-sum-of-device-ratings/  
...
<p>You are given a 2D integer array <code>units</code> of size <code>m × n</code> where <code>units[i][j]</code> represents the capacity of the <code>j<sup>th</sup></code> unit in the <code>i<sup>th</sup></code> device. Each device contains <strong>exactly</strong> <code>n</code> units.</p>
